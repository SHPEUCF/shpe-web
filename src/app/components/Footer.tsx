...
const Footer = () => {
    return (<div className="bg-[#2A3342] text-white 2xl:h-[35rem] h-[30rem] pt-3 flex flex-col justify-around items-center text-slate-400">
      <img className="2xl:w-[6%]" src={logo.src}/>
