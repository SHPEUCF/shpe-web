...
const Banner = ({isMobile} : Prop) => {
  ...
  return (<main className="bg-[#F7F8F9] w-screen 2xl:h-[60rem] lg:h-[35rem] h-[30rem] flex justify-center items-center">
    ...
    <section className="lg:h-[35%] h-[30%] lg:p-4 p-8 absolute z-20 flex flex-col justify-between items-center text-center">
      ...
      <a className="2xl:w-80 2xl:h-16 2xl:text-xl lg:w-52 lg:h-12 w-44 h-9 px-7 py-4 bg-yellow-400 rounded-md shadow justify-center items-center inline-flex text-black lg:text-base text-xs font-medium" href="https://form.jotform.com/70387424224151" target="_blank">Become a Member</a>
