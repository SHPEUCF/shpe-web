...
const Events = ({isMobile} : Prop) => {
  return (<main id="events" className="bg-[#F7F8F9] 2xl:h-[110rem] lg:h-[70rem] h-[80rem] w-screen flex justify-around items-center max-w-[100%]">
    <img src={isMobile ? bgm.src : bg.src} className="absolute z-10 w-screen" />
    <section className="absolute z-20 w-screen 2xl:h-[110rem] lg:h-[70rem] h-[80rem] flex flex-col justify-around items-center 2xl:pt-[9rem] lg:mt-[9rem] max-w-[100%]">
