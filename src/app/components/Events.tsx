    ...
    <section className="absolute z-20 w-screen 2xl:h-[105rem] lg:h-[70rem] h-[80rem] flex flex-col justify-around items-center 2xl:pt-[9rem] lg:mt-[9rem] max-w-[100%]">
      ...
      <section className={`${isMobile ? "flex-col" : ""} w-[90%] h-[80%] flex justify-around`}>
        <article>
          ...
          <Event link="https://shpe.org/engage/events/national-convention/" title="SHPE Conference" description="Join SHPE in our signature event and the largest gathering of Hispanics in STEM in the country in Anaheim, California." />
